...
[![My Skills](https://skillicons.dev/icons?i=aws,jenkins,java,spring,react,postgresql,docker,mysql,py,css,js,redux,bootstrap,tailwind,c,git,firebase,materialui,tensorflow,anaconda,sqlite,netlify,flask,fastapi,postman&perline=5)](https://skillicons.dev)
